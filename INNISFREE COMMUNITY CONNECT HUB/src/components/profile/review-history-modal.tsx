...
export function ReviewHistoryModal({ userEmail }: ReviewHistoryModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-5xl h-[90vh] md:h-[80vh] p-0 flex flex-col w-[95vw] md:w-auto">
        ...
        <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
          {/* Sidebar */}
          <div className="w-full md:w-64 border-b md:border-r md:border-b-0 p-4 flex flex-col">
              ...
              <>
                    ...
                    {reviews.map((review) => (
                      <div
                        ...
                        className={`border rounded-lg p-4 cursor-pointer transition-colors ${
                          selectedReview?.id === review.id ? "bg-muted" : "hover:bg-muted/50"
                        }`}
                ...
                {selectedReview && (
                  <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-background rounded-lg shadow-lg w-full max-w-2xl max-h-[90vh] md:max-h-[80vh] overflow-hidden">
                      ...
                      <div className="p-4 md:p-6 overflow-auto max-h-[calc(90vh-8rem)] md:max-h-[calc(80vh-8rem)]">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-4">
                          <div className="h-24 w-24 rounded-md overflow-hidden bg-muted">
                            {selectedReview.product.imageUrl ? (
                              <img
                                src={selectedReview.product.imageUrl || "/placeholder.svg"}
                      ...
                      <div className="p-4 md:p-6 border-t flex flex-col sm:flex-row justify-end gap-2">
                        <Button variant="outline" className="w-full sm:w-auto" onClick={() => setSelectedReview(null)}>
                          Close
                        </Button>
                        <AlertDialog>
                          <AlertDialogTrigger asChild>
                            <Button variant="destructive" className="w-full sm:w-auto mt-2 sm:mt-0">
                              <Trash2 className="h-4 w-4 mr-2" />
                              Delete Review
                            </Button>
                          </AlertDialogTrigger>
                        ...
                        <div className="flex flex-col gap-1 mt-2 mb-3">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-gray-600">
                              {capitalizeFirstLetter(rec.product.subcategory)}
                            </span>
                          </div>
                        </div>
                        <div className="flex items-center justify-between">
                          <p className="text-green-600 font-medium">RM {rec.product.price.toFixed(2)}</p>
                          <Button
                            variant="outline"
                            size="sm"
